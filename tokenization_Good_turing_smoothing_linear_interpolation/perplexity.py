...
tokenized_user_input_sentences = [tokenizer.tokenize(sentence,remove_stop_words=False) for sentence in remaining_sentences]
...
with open('2023201078_LM4_train-perplexity.txt', 'w') as file:
    ...
    avg_train_perplexity = total_train_perplexity / len(remaining_sentences)
    file.seek(0)  # Move the file pointer to the beginning of the file
    file.write(f"Avg Train Perplexity: {avg_train_perplexity}\n")  # Write average perplexity at the beginning

print(avg_train_perplexity)

total_test_perplexity = 0
with open('2023201078_LM4_test-perplexity.txt', 'w') as file:
    for sentence in selected_sentences:
        perplexity = getPerplexity(sentence, n, ngramToCount, ngramToProbs, unseenProb,0)
        file.write(f"{sentence}\t {perplexity}\n\n")
        total_test_perplexity += perplexity
    avg_test_perplexity = total_test_perplexity/len(selected_sentences)
    file.seek(0)  # Move the file pointer to the beginning of the file
    file.write(f"Avg test Perplexity: {avg_test_perplexity}\n")  # Write average perplexity at the beginning
print(avg_test_perplexity)

# perplexity = getPerplexity("""a yellow dressinggown""", n, ngramToCount, ngramToProbs, unseenProb,1)
# print(perplexity)
